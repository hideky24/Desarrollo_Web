...
<div class="container" >
        ...
        <?php
            while ($patient = mysqli_fetch_object($data)){
                ...
                echo "<div class='center'> <a class='btn btn-success' href='". ROOT ."/cliente/edit.php?id=$patient->id' >Modificar</a> - <a class='btn btn-danger' href='". ROOT ."/cliente/index.php?id=$patient->id' >Eliminar</a> </div>";
